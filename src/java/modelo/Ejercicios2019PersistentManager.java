...
public class Ejercicios2019PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Ejercicios2019";
	...
	private Ejercicios2019PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Ejercicios2019PersistentManager();
		}
